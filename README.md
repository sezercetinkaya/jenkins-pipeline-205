# Project-205: Jenkins Pipeline for Web Page Application (Postgresql-Nodejs-React) deployed on EC2's with Ansible and Docker
...
- For PostgreSQL worker node
  ...
  - For React worker node
    ...
    - Create React container and publish it on container port 3000 and host port 80.
